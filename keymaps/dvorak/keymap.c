...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NUMPAD] = LAYOUT(
	KC_PPLS, 	KC_7, 		KC_8, 		KC_9, 		KC_PAST, 	KC_MPLY,	KC_MPRV, 	KC_UP, 		KC_MNXT,	KC_TRNS,
	KC_LSFT, 	KC_4, 		KC_5, 		KC_6, 		KC_PMNS, 	KC_DEL, 	KC_LEFT,	KC_DOWN,	KC_RGHT,	KC_LCTL,
	KC_0, 		KC_1, 		KC_2, 		KC_3, 		KC_PSLS, 	KC_TRNS, 	KC_EXLM, 	KC_CIRC, 	KC_PERC, 	MO(_MOUSE),
